...
<div style="width: 70%; height: 100%; min-width: 900px; background-color: #d2d4dc;" class="marginauto">
	...
	<div style="width: 80%; height: 80%; display: flex; margin-top: 8%" class="marginauto">
		...
		<form action="#" style="width: 100%; height: 100%;">
			...
			<div class="rightdiv">
				<input class="input" type="text" id="genderboolean" name="genderboolean" value="${bLogin.genderboolean }" placeholder="성별" readonly>
				<input class="origininput">
			</div>
			<div class="rightdiv">
				<input class="input" type="text" id="phonenum" name="phonenum" value="${bLogin.phonenum }" placeholder="휴대폰 번호" readonly>
				<input class="origininput">
			</div>
			<div class="rightdiv">
			...
			<div class="rightdiv">
				<input class="input" type="text" id="address" value="${bLogin.mainaddress } ${bLogin.detailaddress }" placeholder="주소" readonly>
				<input class="origininput">
			</div>
			<div class="rightdiv">
