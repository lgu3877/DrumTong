		...
		<div class="search_inner">
			...
			<div class="account_searchbox">
				...
				<div class="search_option_con">
					...
					<!-- Name & Email -->
						<li class="search_options" onclick='openForm("email-search")'>
							<i id="email-search-icon" class="fas fa-angle-down"></i>
							<div>이메일로 찾기</div>
						</li>
					...
					<!-- Name & PhoneNumber -->
						<li class="search_options" onclick='openForm("hp-search")'>
							<i id="hp-search-icon" class="fas fa-angle-down"></i>
							<div>전화번호로 찾기</div>
						</li>
						
						<li id="hp-search" class="search_input_con" style="display: none">
							<form method="POST" onsubmit='phoneNumCheck("name-phone-search")'>
								<div>
									<div class="search_input_label">이름</div>
									<input class="single_input" type="text" name="name" placeholder="이름을 적어주세요." />
								</div>
								<div>
									<div class="search_input_label">
										전화번호
										<span class="search_input_sublabel">('-'을 제외한 숫자로 적어주세요.)</span>
									</div>
									<input id="name-phone-search" class="single_input" type="text" name="phonenum" placeholder="예) 01012345678" maxlength="11" />
									<!-- error message -->
					...
					<!-- Name & Birth & Gender -->
						<li class="search_options" onclick='openForm("birth-search")'>
							<i id="birth-search-icon" class="fas fa-angle-down"></i>
							<div>생년월일로 찾기</div>
						</li>
						...
						<li id="birth-search" class="search_input_con" style="display: none">
							...
							<!-- gender -->
								...
								<!-- male -->
									...
									<label id="male_label" class="gender_label male_select" for="male_radio"
										onclick="radioCheck('male')">남성</label>
								<!-- female -->
									<input class="radio_input" id="female_radio" type="radio" name="gender" value="F" />
									<label id="female_label" class="gender_label female_select" for="female_radio" 
										onclick="radioCheck('female')">여성</label>
								</div>
							<!-- submit -->
								<div>
									<input class="single_input" type="submit" value="확인" />
					...
					<!-- BusinessNumber & Email -->
						<li class="search_options" onclick='openForm("bEmail-search")'>
							<i id="bEmail-search-icon" class="fas fa-angle-down"></i>
							<div>사업자 등록번호(이메일)로 찾기</div>
						</li>
						...
						<li id="bEmail-search" class="search_input_con" style="display: none">
							<form method="POST">
								<div>
									<div class="search_input_label">이메일</div>
									<input class="single_input" type="text" name="email"
					...
					<!-- BusinessNumber & PhoneNumber -->
						<li class="search_options" onclick='openForm("bPhone-search")'>
							<i id="pPhone-search-icon" class="fas fa-angle-down"></i>
							<div>사업자 등록번호(전화번호)로 찾기</div>
						</li>
			...
			<div class="account_searchbox">
				...
				<div class="search_option_con">
					...
					<!-- ID & Email & PhoneNumber for Password -->
						<li class="search_options" onclick='openForm("PwPhone-search")'>
							<i id="PwPhone-search-icon" class="fas fa-angle-down"></i>
							<div>전화번호로 찾기</div>
						</li>
							...
							<form method="POST">
								...
								<div>
									...
									<div class="phone_auth_con">
										...
										<button id="auth_phone_btn" class="phone_auth_btn" type="button" onclick="authInput('auth_phone')">
											인증번호 받기
										</button>
									</div>
								</div>
							<!-- authentication code input -->	
								<div id="auth_phone_div"></div>
								<div>
									<input class="single_input" type="submit" value="확인" />
								</div>
							</form>
					...
					<!-- ID & Email for Password -->
						<li class="search_options" onclick='openForm("PwEmail-search")'>
							<i id="PwEmail-search-icon" class="fas fa-angle-down"></i>
							<div>이메일로 찾기</div>
						</li>
							...
							<form method="POST">
								...
								<div>
									...
									<div class="email_auth_con">
										...
										<button id="auth_email_btn" class="email_auth_btn" type="button" onclick="authInput('auth_email')">
											인증번호 받기
										</button>
									</div>
								</div>
							<!-- authentication code input -->
								<div id="auth_email_div"></div>
								<div>
									<input class="single_input" type="submit" value="확인" />
								</div>
							</form>
