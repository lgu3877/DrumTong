  ...
  <div class="orderlist-wrap">
    ...
    <div class="orderlist-card">
      <div class="orderData1">
        ...
        <div class="orderData-date">주문일자 : ${ol.purchasedate }</div>
      </div>
      <div class="orderData2">
        ...
        <div class="orderData-options">
          ...
          <div class="orderData-options-head">쿠폰</div>
          <ul>
            <li>쿠폰 1 -1,000원 ${ol.discountprice }원</li>
          </ul>
        </div>
      </div>
      <div class="orderData-total">Total ${ol.totalprice }</div>
    </div>
    </c:forEach>
    </c:if>
