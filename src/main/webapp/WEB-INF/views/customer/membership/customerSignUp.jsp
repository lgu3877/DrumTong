    ...
    <section class="section-SangJae section-join">
      <div class="join">
          ...
          <form method="POST" id="loginForm" class="joinForm">
            ...
            <input type="button" value="주소찾기" onclick="searchAddress(document.getElementById('zipcode'),document.getElementById('address'),null, null, null)" id="findZipcode" class="join-input-buttons" />
