					...
					<div class="laundryLists_1">
						<a href="${cpath }/customer/laundry/customerDetail/${li.estid}/">
							...
							<div class="laundryLists_1_2">
								<p style="display:inline-block;width:350px;font-size: 20px;font-weight:bold;">${li.brandnaming } (${li.reviewnum })</p>
								<p style="display:inline-block;width:100px;text-align: right;">
